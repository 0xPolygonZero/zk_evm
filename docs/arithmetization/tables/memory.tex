...
\begin{itemize}
  \item Before the CPU cycles, we initialize the memory with the MemBefore values and we write some global metadata. These operations are done at timestamp $\tau = 0$.
