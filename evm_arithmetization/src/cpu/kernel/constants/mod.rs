...
pub(crate) fn evm_constants() -> HashMap<String, U256> {
    ...
    c.insert(ADDRESS_GLOBAL_EXIT_ROOT_MANAGER_L2.0.into(), U256::from_big_endian(&ADDRESS_GLOBAL_EXIT_ROOT_MANAGER_L2.1));
    c.insert(GLOBAL_EXIT_ROOT_STORAGE_POS.0.into(), U256::from(GLOBAL_EXIT_ROOT_STORAGE_POS.1));
...
pub const ADDRESS_GLOBAL_EXIT_ROOT_MANAGER_L2: (&str, [u8; 20]) = ("ADDRESS_GLOBAL_EXIT_ROOT_MANAGER_L2", hex!("a40D5f56745a118D0906a34E69aeC8C0Db1cB8fA"));
...
pub const GLOBAL_EXIT_ROOT_CONTRACT_CODE_HASH: [u8; 32] = hex!("6bec2bf64f7e824109f6ed55f77dd7665801d6195e461666ad6a5342a9f6daf5");
pub const GLOBAL_EXIT_ROOT_ADDRESS_HASHED: [u8; 32] = hex!("1d5e9c22b4b1a781d0ef63e9c1293c2a45fee966809019aa9804b5e7148b0ca9");
