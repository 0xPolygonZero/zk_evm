    ...
    C::Hasher: AlgebraicHasher<F>,
{
    ...
    /// Creates a final batch transaction proof, once all segments of a given
    /// batch of transactions have been combined into a single aggregation
    /// proof.
    ///
    /// Batch transaction proofs can either be generated as a standalone, or
    /// combined with a previous batch transaction proof to assert validity of a
    /// range of transactions.
    ///
    /// # Arguments
    ///
    /// - `opt_parent_txn_proof`: an optional parent batch transaction proof.
    ///   Passing one will generate a proof of validity for both the transaction
    ...
    ///   within the current batch of transactions.
