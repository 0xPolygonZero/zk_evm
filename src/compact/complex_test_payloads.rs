...
use super::compact_prestate_processing::{
    process_compact_prestate, process_compact_prestate_debug, CompactParsingResult, Header,
};
use crate::{
...
type ProcessCompactPrestateFn = fn(
    TrieCompact,
...
impl TestProtocolInputAndRoot {
    ...
    fn parse_and_check_hash_matches_common(
        ...
        let (header, trie, _) = match process_compact_prestate_f(TrieCompact {
